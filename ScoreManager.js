...
class ScoreManager {
    ...
    drawScore(context, canvasWidth, canvasHeight) {
        ...
        context.fillText(`Score: ${this.currentScore}`, 10, 70);
        
        // High score - top left, below current score
        context.fillText(`High: ${this.highScore}`, 10, 90);
        
        // Last score - top left, below high score
        if (this.lastScore > 0) {
            context.fillText(`Last: ${this.lastScore}`, 10, 110);
        }
    }
    ...
    drawGameOverScore(context, isNewHighScore, previousHighScore) {
        ...
        if (this.currentScore === 0) {
            ...
            context.fillText("NEW HIGH SCORE!", centerX, 290);
            context.fillStyle = "white";
            context.fillText(`Your Score: ${this.currentScore}`, centerX, 315);
            ...
            context.fillText(`Need ${difference} more to beat high score`, centerX, 340);
        }
